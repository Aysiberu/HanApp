...
export default async function handler(req, res) {
  ...
  try {
    const body = req.body || {};
    const { providerId, userId, service_types, company, availability, availability_from, availability_to, certificate_url, profile_photo_url, price_per_hour, location, bio } = body;
